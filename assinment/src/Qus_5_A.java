...
public class Qus_5_A {
// main method take array of building
    public List<List<Integer>> getSkyline(int[][] buildings) {
        ...
        //Place the point with the lesser height if the heights of the two points are equal.
        // initially, then add a smaller beginning point after that
    ...
    public static void main(String[] args) {
        int[][] buildings = {{1,4,10},{2,5,15},{5,8,12},{9,11,1},{11,13,15}};
        Qus_5_A solution = new Qus_5_A();
        List<List<Integer>> skyline = solution.getSkyline(buildings);
        System.out.println(skyline); // Output: [[1, 10], [2, 15], [5, 12], [8, 0], [9, 1], [11, 15], [13, 0]]
    }
